            ...
            <div class="col-md-6 right">
                <form action="login" method="post">
                    <div class="input-box">
                        ...
                        <div class="col-12 col-lg-5 d-flex align-items-center w-100 mt-4">
                            <div class="d-flex gap-3 flex-column w-100 ">
                                <a href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:8080/login-google&response_type=code&client_id=699948437114-5fmaukufd0gcuskoh2m4sqvg1gumvrb1.apps.googleusercontent.com&approval_prompt=force"
                                ...
                                <a href="https://www.facebook.com/dialog/oauth?client_id=834711912111347&redirect_uri=http://localhost:8080/login-facebook"
                                   class="btn bsb-btn-2xl btn-outline-dark rounded-0 d-flex align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
