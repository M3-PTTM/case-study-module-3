                    ...
                    <div class="input-box">
                        ...
                        <div class="col-12 col-lg-5 d-flex align-items-center w-100 mt-4">
                            <div class="d-flex gap-3 flex-column w-100 ">
                                ...
                                <a href="https://www.facebook.com/dialog/oauth?client_id=834711912111347&redirect_uri=http://localhost:8080/login-facebook" class="btn bsb-btn-2xl btn-outline-dark rounded-0 d-flex align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
